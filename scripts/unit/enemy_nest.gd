...
const Units = [
	preload("res://objects/units/enemy_rusher.tscn"),
	preload("res://objects/units/enemy_ranger.tscn"),
	preload("res://objects/units/enemy_tank.tscn")];
...
func spawn_offender():
	...
	var spawn = Units[randi()%3].instance();
